    ...
    <div className={styles.share}>
      <div className={styles.shareWrapper}>
        ...
        <div className={styles.shareImgContainer}>
          <img className={styles.shareImg} src={URL.createObjectURL(media)} alt="" />
          <Icon name="cancel" className={styles.shareCancelImg} onClick={() => setMedia(null)} />
        </div>
      )}
